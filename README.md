...
![Version](https://img.shields.io/badge/version-2.8.4-ff4500)
...
2. Download `FlareDownload_Setup_2.8.4.exe`
3. Run the installer
...
4. Create `installer_output\FlareDownload_Setup_2.8.4.exe` (installer)
